...
rekursiv (entscheidbar)                & $\mathcal{L}_R$    & \begin{tabular}[c]{@{}l@{}}Wird von einer TM akzeptiert\\ Die TM h{\"a}lt bei jedem eingegebenen Wort\end{tabular} &                     \\ \hline
rekursiv aufz{\"a}hlbar (semientscheidbar) & $\mathcal{L}_{RE}$ & \begin{tabular}[c]{@{}l@{}}Wird von einer TM akzeptiert\\ Die TM h{\"a}lt bei jedem akzeptierten Wort\end{tabular} & $(L_\text{diag})^C$ \\ \hline
