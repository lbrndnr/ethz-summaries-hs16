...
Sei $L$ kontextfrei. Dann existiert eine nur von $L$ abh{\"a}ngige Kontante $n_L$, so dass f{\"u}r alle W{\"o}rter $z \in L$ mit $|z| \geq n_L$ eine Zerlegung $z = uvwxy$ von $z$ existiert, so dass:
\begin{enumerate}[label=(\roman*), noitemsep]
	\item $|vx| \geq 1$
	\item $|vwx| \leq n_L$
...
Eine \textbf{k-KNF} ist eine KNF, bei der jede Klausel aus h{\"o}chstens 3 Literalen besteht.
