...
\begin{equation*}
\begin{split}
	\textbf{Annahme:}\quad & \Var[X_i] = \sigma^2 \\
	...
	\textbf{Verwerfungsbereich:}\quad & |T| > \Phi^{-1}(1- \frac{\alpha}{2})  \qquad\text{für } H_A: \vartheta \neq \vartheta_0 \text{ (beidseitig)} \\ 
	& T < - \Phi^{-1}(1 - \alpha) \qquad\text{für } H_A: \vartheta < \vartheta_0 \text{ (einseitig)} \\ 
	& T > \Phi^{-1}(1 - \alpha) \qquad\text{für } H_A: \vartheta > \vartheta_0 \text{ (einseitig)}
\end{split}
\end{equation*}
...
\begin{split}
	...
	\textbf{Teststatistik:}\quad & T := \frac{\overline{X}_n - \mu_0}{S/\sqrt{n}} \sim t_{n-1} \qquad \text{($t$-verteilt mit $n-1$ Freiheitsgraden)} \\
		\textbf{Verwerfungsbereich:}\quad & |T| > (t_{n-1})^{-1}(1-\frac{\alpha}{2})\qquad\text{für } H_A: \vartheta \neq \vartheta_0 \text{ (beidseitig)} \\ 
	& T < - (t_{n-1})^{-1}(1 - \alpha) \qquad\text{für } H_A: \vartheta < \vartheta_0 \text{ (einseitig)} \\ 
	& T > (t_{n-1})^{-1}(1 - \alpha) \qquad\text{für } H_A: \vartheta > \vartheta_0 \text{ (einseitig)}
\end{split}
\end{equation*}
