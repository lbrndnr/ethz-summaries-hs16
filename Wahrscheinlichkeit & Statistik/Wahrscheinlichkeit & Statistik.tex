...
$X = k$ heisst gerade, dass $A_1,..., A_{k-1}$ nicht eintreten und $A_k$ als erstes eintritt. Weiter ist der \textbf{Erwartungswert} und die \textbf{Varianz} gleich
\begin{equation*}
\begin{split}
	\E[X] & = \frac{1}{p} \\
	\Var[X] & = \frac{1-p}{p^2}
...
Die \textbf{Poisson-Verteilung} mit Parameter $\lambda \in (0, \infty)$ beschreibt die Anzahl Ereignisse in einem Zeitintervall. Sie ist eine Verteilung auf der Menge $\mathbb{N}_0$ mit Gewichtsfunktion
\begin{equation*}
